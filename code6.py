...
# # Function to handle wrirting key
# def write_key():
...
# # Generate a write a new key
# write_key()

# # load the previously generated key
# key = load_key()

# print("The key is " + str(key.decode( 'utf-8')))

# # Message to be encrypted 
# message = "This is the secret".encode()

# print("Plaintext is " + str(message))
